...
class TrackInspectionCase(Base):
    ...
    # Optional human-readable name managed by Admin.
    # inspection_id remains the stable technical identity.
    case_name: Mapped[Optional[str]] = mapped_column(
        String(160),
        nullable=True,
    )
    ...
    ai_overall_priority: Mapped[Optional[str]] = mapped_column(
        String(60),
        nullable=True,
        index=True,
    )

    ai_snapshot: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
    )

    media_snapshot: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
    )
    ...
    verifying_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    )
...
class TrackIssue(Base):
    ...
    inspection_event_id: Mapped[str] = mapped_column(
        String(64),
        nullable=False,
    )
    ...
    rail_side: Mapped[Optional[str]] = mapped_column(
        String(20),
        nullable=True,
    )
    ...
    field_verification_note: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
    )

    field_verified_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    )
    ...
    maintenance_note: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
    )

    repair_started_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    )

    repair_completed_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    )
    ...
    last_location_distance_miles: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
    )

    last_location_proximity: Mapped[Optional[str]] = mapped_column(
        String(30),
        nullable=True,
    )
    ...
    field_verified_by_staff = relationship(
        "Staff",
        foreign_keys=[field_verified_by_staff_id],
    )
...
class TrackCaseActivity(Base):
    ...
    distance_to_issue_miles: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
    )

    proximity: Mapped[Optional[str]] = mapped_column(
        String(30),
        nullable=True,
    )
    ...
    actor_staff = relationship(
        "Staff",
        foreign_keys=[actor_staff_id],
    )
